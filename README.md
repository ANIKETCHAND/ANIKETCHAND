...
### 🕵️ AP Console
**Authenticity & Provenance Console** — full-stack media forensics + threat intel platform

- Image / video / audio manipulation detectors (FFT, ELA, sensor-noise variance, blink-rate analysis)
- Breach, phishing, GitHub-secrets & Shodan scanning
- Google OAuth + JWT sessions, SQLite case history
- Built-in AI analyst chat
- **Stack:** `FastAPI` · `Python` · `SQLite` · `HTML/CSS/JS`

</td>
<td width="50%" valign="top">

### 🛰️ Spoof Killer
Passive **DNS spoofing / MITM detection** tool

- 5-heuristic detection engine: multi-answer race, source-IP mismatch, reply timing, TTL anomaly, cross-resolver verification
- Real-time passive packet analysis
- **Stack:** `Python` · `Scapy` · `dnspython`
...
### 🎭 ACPC (Veritas)
**Deepfake detection platform** with real forensic heuristics

- Image: FFT, ELA, sensor-noise variance, facial symmetry
- Video: frame sampling, blink-rate analysis
- Audio: pitch contour, spectral flatness, MFCC delta
- **Stack:** `FastAPI` · `Python` · `Glassmorphic UI`
